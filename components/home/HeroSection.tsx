  ...
  return (
    ...
    >
      ...
      {/* ══════════════════════════════════════
          ...
          Image-first, thumb-friendly, minimal
      ══════════════════════════════════════ */}
      <div className="block lg:hidden">
        ...
        <div className="px-5 pt-7 pb-5">
          ...
          >
            <Link href="/equipment" className="block">
              <Button className="w-full h-12 gap-2 bg-blue-600 hover:bg-blue-500 text-white text-[15px] font-medium border-0 rounded-xl transition-colors cursor-pointer">
                浏览在售设备
            ...
            <Link
              href="/contact"
              className="flex items-center justify-center gap-1.5 h-10 text-sm text-[#707080] hover:text-white transition-colors"
            >
              提交采购需求
              <ArrowRight size={14} />
            </Link>
        ...
        <motion.div
          ...
          className="mx-5 border-t border-white/[0.07] grid grid-cols-4 py-5"
        >
          {stats.map((stat, i) => (
            <div
              key={stat.label}
            ...
            >
              <p className="text-lg font-semibold text-white leading-none mb-1">{stat.value}</p>
              <p className="text-[10px] text-[#606070]">{stat.label}</p>
            </div>
          ))}
        </motion.div>
        ...
        <motion.div
          ...
          className="px-5 pb-10 flex items-center gap-2 flex-wrap"
        >
          <span className="text-[10px] text-[#505060]">覆盖品牌</span>
          {badges.map((b) => (
            <span
              key={b}
              className="text-[11px] font-medium text-[#9090a0] bg-white/[0.04] border border-white/[0.07] rounded-md px-2 py-0.5"
            >
              {b}
            </span>
          ))}
          <span className="text-[11px] text-[#505060]">等10+</span>
        </motion.div>
      </div>
